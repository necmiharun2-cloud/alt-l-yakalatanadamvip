...
export default function FeatureCards() {
  ...
  return (
    <section className="relative bg-[#080d16] pt-24 pb-12 px-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-20 gap-8 lg:gap-16">
          ...
          <div className="flex-1 border-l-[3px] border-[#00e5ff]/30 pl-8 h-full flex items-center md:max-w-xl">
            ...
            >
              ...
              {card.hasBottomYellow && (
                <div className="absolute right-0 bottom-0 z-20 rounded-br-2xl overflow-hidden">
                  <div className="w-0 h-0 border-b-[36px] border-b-[#00e5ff] border-l-[36px] border-l-transparent"></div>
                </div>
              )}
        ...
        <div className="mt-16 flex flex-col sm:flex-row items-center justify-end space-y-4 sm:space-y-0 sm:space-x-4">
          <a href="#" className="flex items-center space-x-3 bg-black/50 hover:bg-black/80 px-5 py-3 rounded-xl border border-white/10 transition-all hover:scale-105 group">
            <Apple size={24} className="text-white group-hover:text-[#00e5ff] transition-colors" />
          ...
          <a href="#" className="flex items-center space-x-3 bg-black/50 hover:bg-black/80 px-5 py-3 rounded-xl border border-white/10 transition-all hover:scale-105 group">
            <Smartphone size={24} className="text-white group-hover:text-[#00e5ff] transition-colors" />
            <div className="flex flex-col text-left">
          ...
          <button className="hidden sm:flex ml-4 w-10 h-10 bg-[#0a0f18] hover:bg-[#151b27] border border-white/10 rounded-full items-center justify-center transition-colors">
