    ...
    <section className="relative w-full h-[600px] md:h-[700px] overflow-hidden bg-[#0a0a0a]">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="absolute top-1/2 -translate-y-1/2 -left-[50%] md:-left-[25%] w-[150%] md:w-[70%] h-[200%] bg-[#080d16] rounded-full blur-[8px] opacity-95 pointer-events-none" />
        </motion.div>
      </AnimatePresence>
      ...
      <div className="relative max-w-7xl mx-auto h-full px-4">
         ...
         >
            ...
            <div>
              <a href={items[index].ctaLink} className="inline-flex items-center space-x-3 bg-[#0c121e] hover:bg-[#151b27] border border-white/10 text-white px-8 py-4 rounded-[30px] font-bold text-sm transition-all group shadow-2xl">
      ...
      <div className="absolute left-4 md:left-8 lg:left-[calc(50%-600px)] bottom-12 flex items-center bg-[#00e5ff] rounded-2xl overflow-hidden shadow-2xl z-20">
        ...
        <div className="flex flex-col bg-[#111111]">
          <button onClick={next} className="p-3 bg-[#181818] hover:bg-[#252525] border-b border-black transition-colors group cursor-pointer">
            <ChevronRight size={18} className="text-white group-hover:text-[#00e5ff] transition-colors" />
          </button>
          <button onClick={prev} className="p-3 bg-[#181818] hover:bg-[#252525] transition-colors group cursor-pointer">
            <ChevronLeft size={18} className="text-white group-hover:text-[#00e5ff] transition-colors" />
          </button>
        </div>
      </div>
    </section>
