  ...
  return (
    <section className="relative w-full h-[600px] overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="relative max-w-7xl mx-auto h-full flex items-center px-4">
        ...
        <div className="absolute left-4 bottom-20 flex items-center bg-[#00e5ff] rounded-xl overflow-hidden shadow-2xl z-20">
        ...
        >
          <span className="inline-block px-4 py-1 bg-[#00e5ff] text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-full mb-6 italic">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white leading-[1.1] mb-6 tracking-tighter">
            ...
            <span className="text-white">İkramiye</span> <span className="text-[#00e5ff]">511.589,37 TL</span>
          </h1>
          ...
          <div className="flex items-center space-x-4">
            <button className="bg-[#00e5ff] hover:bg-white hover:text-black text-white px-8 py-4 rounded-full font-black uppercase tracking-wider text-xs flex items-center space-x-3 transition-all transform hover:scale-105 shadow-xl">
      ...
      <div className="absolute bottom-8 right-8 flex space-x-2">
        {[1, 2, 3].map((i) => (
          <div 
            key={i} 
            className={`w-2 h-2 rounded-full transition-all ${i === 1 ? 'bg-[#00e5ff] w-8' : 'bg-white/30'}`}
          />
        ))}
      </div>
    </section>
