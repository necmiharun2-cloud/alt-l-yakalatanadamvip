...
export default function LatestPosts() {
  ...
  return (
    <section className="relative py-32 px-4 overflow-hidden bg-[#0a0a0a]">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-[#080d16] via-[#080d16]/80 to-[#080d16]" />

      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 border-l-4 border-[#00e5ff] pl-8">
          <div>
            <h2 className="text-5xl font-black text-white italic tracking-tighter mb-4 underline decoration-[#00e5ff] decoration-4 underline-offset-8">
