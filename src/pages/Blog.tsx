    ...
    <div className="min-h-screen bg-[#080d16] text-white selection:bg-[#00e5ff] selection:text-white">
      ...
      <main className="max-w-7xl mx-auto pt-32 pb-20 px-4">
        ...
        <div className="flex items-center space-x-2 text-[10px] font-black uppercase tracking-widest text-gray-600 mb-8">
          ...
          <span className="text-[#00e5ff]">Blog</span>
        </div>
          ...
          <aside className="w-full lg:w-[350px] space-y-12">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="inline-block px-8 py-3 bg-[#00e5ff] text-black text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg">
                  Katılın
                </div>
              </div>
            </motion.div>
                  ...
                  >
                    <Link to={`/blog/${post.slug}`} className="flex flex-col h-full">
                      ...
                      <div className="p-8 flex-1 flex flex-col">
                        ...
                        <div className="mt-auto pt-4 border-t border-white/5 text-[#00e5ff] text-[10px] font-black uppercase tracking-widest">
                          Devamını Oku
                        </div>
                      </div>
                    </Link>
